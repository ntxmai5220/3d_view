    ...
    if (o.lighting) {
      ...
      for (int i = 0; i < indexCount; i++) {
        ...
        if (renderIndices[indexOffset + i] != null) {
          ...
          renderColors[vertexOffset + p.vertex0] = o.light.shading(viewPosition, a, normal, material).value;
          renderColors[vertexOffset + p.vertex1] = o.light.shading(viewPosition, b, normal, material).value;
          renderColors[vertexOffset + p.vertex2] = o.light.shading(viewPosition, c, normal, material).value;
        }
      }
    } else {
