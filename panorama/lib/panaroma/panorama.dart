...
import 'package:panaromaplugin/panaroma/Widgets/ObjectAdding/extObjectFAB.dart';
import 'flutter_cube/flutter_cube.dart';
import 'package:panaromaplugin/panaroma/Widgets/Delete/ExtFABDel.dart';
import 'package:panaromaplugin/panaroma/Widgets/Delete/FABDel.dart';
import 'package:panaromaplugin/panaroma/Widgets/Fab/ExtFAB.dart';
import 'package:panaromaplugin/panaroma/Widgets/Fab/FAB.dart';
import 'package:panaromaplugin/panaroma/Widgets/Image/DetailImage.dart';
import 'package:panaromaplugin/panaroma/Widgets/Model/ModalBottomSheet.dart';
import 'package:panaromaplugin/panaroma/Widgets/Model/ModalObjectSheet.dart';
import 'package:panaromaplugin/panaroma/Widgets/ObjectAdding/ObjectFAB.dart';
...
class _PanoramaState extends State<Panorama>
  ...
  void _handleAddHospot(double longitude, double latitude, double tilt) async {
    int index = await customSheet(context, widget.child!);
    String uuid = Uuid().v1();
  ...
  void changeColor(Color color) {
    // if (currentObj != null) {
    //   currentObj!.light.setColor(color, 2, 2, 20);
    // }
    changeCorlorObjectRec(this.currentObj!, color, 1);
    // this.sceneObj!.light.setColor(color, 2, 2, 20);
